const API_KEY = 'sk-V2T5h1fG16VcfwLi7b731102100344DdAe4dF2C482A90142TTS';
    ...
    if (path === "/v1/audio/speech") {
        try {
            ...
            const { 
                ...
                speed = '1.0',
                volume='0',
                pitch = '0', // 添加 pitch 參數，默認值為 0
                style = "general"//添加style參數，默認值為general
            } = requestBody;
...
async function getVoice(text, voiceName = "zh-TW-YunJheNeural", rate = '+0%', pitch = '+0Hz', volume='+0%',style = "general", outputFormat = "audio-24khz-48kbitrate-mono-mp3") {
    try {
